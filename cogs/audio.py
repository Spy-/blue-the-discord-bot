...
class Audio:
    ...
    @audioset.command(name="cachemax", hidden=True)
    @checks.is_owner()
    ...
    @audioset.command(name="maxlength", hidden=True)
    @checks.is_owner()
    ...
    @audioset.command(name="player", hidden=True)
    @checks.is_owner()
    ...
    @audioset.command(name="status", hidden=True)
    ...
    @audioset.command(pass_context=True, name="vote", no_pm=True, hidden=True)
    @checks.mod_or_permissions(manage_messages=True)
    ...
    @audiostat.command(name="servers", hidden=True)
    ...
    @cache.command(name="dump", hidden=True)
    @checks.is_owner()
    ...
    @cache.command(name='stats', hidden=True)
    ...
    @local.command(name="list", no_pm=True, hidden=True)
    ...
    @playlist.command(pass_context=True, no_pm=True, name="create", hidden=True)
    ...
    @playlist.command(pass_context=True, no_pm=True, name="append", hidden=True)
    ...
    @playlist.command(pass_context=True, no_pm=True, name="extend", hidden=True)
    ...
    @playlist.command(pass_context=True, no_pm=True, name="queue", hidden=True)
    ...
    @playlist.command(pass_context=True, no_pm=True, name="remove", hidden=True)
    ...
    @commands.command(pass_context=True, no_pm=True, name="queue", hidden=True)
    ...
    async def sing(self, ctx):
        """Makes the bot sing an amazing song"""
        ids = ("bFEoMO0pc7k", "PfYnvDL0Qcw", "dQw4w9WgXcQ")
    ...
    async def bee(self, ctx):
        url = "https://soundcloud.com/shinji-ikari-553202509/bee-movie-script"
        await ctx.invoke(self.play, url_or_search_terms=url)
    ...
    @commands.command(name="yt", pass_context=True, no_pm=True, hidden=True)
