...
class General:
    ...
    async def twenty_seventeen():
        """Posts the the best picture of 2017"""
        await self.bot.send_file("2017.gif")
 '''
    ...
    @commands.command(name="jaden")
    async def _jaden(self):
        """Will read a Jaden Smith Tweet to the whole server."""
        await self.bot.say("`" + choice(self.jadenQuotes) + "`")
